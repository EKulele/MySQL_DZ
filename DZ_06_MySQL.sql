...
-- 1.2 Выведите список товаров products и разделов catalogs, который соответствует товару.
...
FROM products INNER JOIN catalogs
ON products.catalog_id = catalogs.id 
order by products.name, catalogs.name;
